...
@unneeded/unneeded-cli/0.0.0 darwin-x64 node-v10.15.3
...
# Commands
<!-- commands -->
* [`unneeded hello [FILE]`](#unneeded-hello-file)
...
_See code: [src/commands/hello.ts](https://github.com/Wyntau/unneeded/blob/v0.0.0/src/commands/hello.ts)_
